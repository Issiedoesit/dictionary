...
const FilteredSearch = ({ query, searchHistory, modalId  }) => {
  ...
  return (
    ...
    <ModalBodyWrap modalId={'filteredSearch'}>
        <div className={`w-ninetyPercent sm:w-seventyPercent md:w-sixtyPercent lg:w-fiftyPercent h-ninetyPercent grid grid-rows-6 overflow-hidden z-50 rounded-lg py-4 bg-white m-auto`}>
